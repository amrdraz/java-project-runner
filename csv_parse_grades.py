...
with open('../401_grades.csv') as csvFile:
    ...
    for row in reader:
        ...
        StudentQuizGrade(student=student, quiz="Quiz 1", passed_tests=int(row["Q1_passed_tests"]), total_tests=int(row["Q1_total_tests"]), grade_in_percentage=float(row["Q1_grade_in_percentage"])).save()
        StudentQuizGrade(student=student, quiz="Quiz 2", passed_tests=int(row["Q2_passed_tests"]), total_tests=int(row["Q2_total_tests"]), grade_in_percentage=float(row["Q2_grade_in_percentage"])).save()
        StudentQuizGrade(student=student, quiz="Quiz 3", passed_tests=int(row["Q3_passed_tests"]), total_tests=int(row["Q3_total_tests"]), grade_in_percentage=float(row["Q3_grade_in_percentage"])).save()
